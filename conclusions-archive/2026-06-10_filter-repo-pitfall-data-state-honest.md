---
archived: 2026-06-10
challenged_by: 8a1f82b — genome: filter-repo pitfall documented, data state honest
superseded_by: conclusions.md
slug_story: filter-repo-pitfall-data-state-honest
reconstruction_fidelity: separable-sources
reconstruction_note: >
  Archived retroactively June 10 2026 from git history (commit b6b551d).
